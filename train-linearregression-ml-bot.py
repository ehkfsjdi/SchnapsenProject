...
from bots.linear_regression_features3_ml.linear_regression_features3_ml import features
...
if options.train:
    ...
    joblib.dump(model, "./bots/linear_regression_features3_ml/" + options.model_path)
